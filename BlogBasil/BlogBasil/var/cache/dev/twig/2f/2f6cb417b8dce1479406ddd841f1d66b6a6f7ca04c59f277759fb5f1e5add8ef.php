...
class __TwigTemplate_17371adb59bee4e7604e99da59e4931badfd288e6f3ee911ea724ecf0218f5ca extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        // line 12
        if ($this->extensions['Symfony\Bridge\Twig\Extension\SecurityExtension']->isGranted("ROLE_BLOG_ADMIN")) {
            // line 13
            echo "        <a href=\"/newAction\">Nouveau billet</a>
    ";
        }
    ...
    {
        return array (  133 => 13,  131 => 12,  128 => 11,  111 => 9,  94 => 8,  90 => 6,  80 => 5,  69 => 3,  59 => 2,  36 => 1,);
    }
...
{% block body %}
    <section>
        <h1>Contenu</h1>
        {% for post in posts %}
            {{ include('blog/post.html.twig') }}
        {% endfor %}
    </section>
    {% if is_granted('ROLE_BLOG_ADMIN') %}
        <a href=\"/newAction\">Nouveau billet</a>
    {% endif %}
{% endblock %}
", "blog/index.html.twig", "/home/basil/Etudes/M2/S3/Eapp/symfony/BlogSymfony/BlogBasil/templates/blog/index.html.twig");
    }
}
